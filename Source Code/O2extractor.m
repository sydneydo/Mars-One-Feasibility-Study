classdef O2extractor
    ...
    properties (SetAccess = private)
        ...
        PartialPressureBoundingBox = 1.37895146 
        ppO2setPoint
    end
    ...
    methods
        ...
        function O2removed = tick(obj)
            ...
            currentppO2 = obj.Environment.O2Store.currentLevel/obj.Environment.totalMoles*obj.Environment.pressure;
            
            if currentppO2 > (obj.TargetO2PartialPressure+ obj.PartialPressureBoundingBox)
                % Sense environment and determine amount to be removed
                o2molesToRemove = (obj.ppO2setPoint*obj.Environment.totalMoles-obj.Environment.O2Store.currentLevel)/...
                    (obj.ppO2setPoint-1);
