...
%         CH4Vented = 0
    ...
    properties (Access = private)
        ...
        CompressorLowerRechargePressure = 172.368932        % Lower bound of CO2 accumulator pressure by which compressor beings to activate (Converted from 25kPa - REF: "Analyses of the Integration of Carbon Dioxide Removal Assembly, Compressor, Accumulator and Sabatier Carbon Dioxide Reduction Assembly" SAE 2004-01-2496)
        ...
        function currentH2OProduced = tick(obj)
            ...
            if obj.CompressorError == 0 && obj.ReactorError == 0 && obj.SeparatorError == 0
                ...
                if obj.CO2ConsumerDefinition.ResourceStore.currentLevel >= obj.CO2Accumulator.currentCapacity && ... %obj.CO2Accumulator.currentLevel == 0
                    ...
                    CO2taken = obj.CO2ConsumerDefinition.ResourceStore.take(min([obj.CO2Accumulator.currentCapacity,obj.CompressorFlowRate]));
