...
%                 disp('hit2')
            ...
            obj.CurrentDryBiomass = obj.CurrentDryBiomass + ...
                cropGrowthRate/1000/24*obj.cropAreaUsed*obj.ProductionRate;     % NB. that obj.CropArea should correspond to ShelfImpl.CropAreaUsed
...
%             saturatedMoistureVaporPressure = 0.611*abs(17.4*environmentalTemperature/(environmentalTemperature+239));   %239 should be 273.15 (conversion to kelvin - according to the equation for relative humidity used in the SimEnvironment code)
            saturatedMoistureVaporPressure = 0.611*exp(17.4*environmentalTemperature/(environmentalTemperature+273.15));
            actualMoistureVaporPressure = obj.AirProducerDefinition.ResourceStore.VaporPercentage...
                *obj.AirProducerDefinition.ResourceStore.pressure;
