...
%
%   UPDATE 3/29/2015
%   File simulated SF Case - all food brought along - 800 days of food
%   budgeted. Ajacency matrix for PressureDistribution object modified
%   accordingly
%
%   UPDATE 3/26/2015
...
CarriedCalories = numberOfCrew*AvgCaloriesPerCrewPerson*800;    % 120 days worth of calories
...
Inflatable1 = SimEnvironmentImpl('Inflatable 1',70.3,500000,0.265,0.003,0.731,0,0.001,hourlyLeakagePercentage,PotableWaterStore,GreyWaterStore,DirtyWaterStore,DryWasteStore,CarriedFoodStore);     %Note volume input is in Liters.
Inflatable2 = SimEnvironmentImpl('Inflatable 2',70.3,500000,0.265,0.003,0.731,0,0.001,hourlyLeakagePercentage,PotableWaterStore,GreyWaterStore,DirtyWaterStore,DryWasteStore,CarriedFoodStore);     
LivingUnit1 = SimEnvironmentImpl('Living Unit 1',70.3,25000,0.265,0.003,0.731,0,0.001,hourlyLeakagePercentage,PotableWaterStore,GreyWaterStore,DirtyWaterStore,DryWasteStore,CarriedFoodStore);   % Note that here we assume that the internal volume of the Dragon modules sent to the surface is 25m^3
LivingUnit2 = SimEnvironmentImpl('Living Unit 2',70.3,25000,0.265,0.003,0.731,0,0.001,hourlyLeakagePercentage,PotableWaterStore,GreyWaterStore,DirtyWaterStore,DryWasteStore,CarriedFoodStore);
LifeSupportUnit1 = SimEnvironmentImpl('Life Support Unit 1',70.3,25000,0.265,0.003,0.731,0,0.001,hourlyLeakagePercentage,PotableWaterStore,GreyWaterStore,DirtyWaterStore,DryWasteStore,CarriedFoodStore);
LifeSupportUnit2 = SimEnvironmentImpl('Life Support Unit 2',70.3,25000,0.265,0.003,0.731,0,0.001,hourlyLeakagePercentage,PotableWaterStore,GreyWaterStore,DirtyWaterStore,DryWasteStore,CarriedFoodStore);
CargoUnit1 = SimEnvironmentImpl('Cargo Unit 1',70.3,25000,0.265,0.003,0.731,0,0.001,hourlyLeakagePercentage,PotableWaterStore,GreyWaterStore,DirtyWaterStore,DryWasteStore,CarriedFoodStore);
CargoUnit2 = SimEnvironmentImpl('Cargo Unit 2',70.3,25000,0.265,0.003,0.731,0,0.001,hourlyLeakagePercentage,PotableWaterStore,GreyWaterStore,DirtyWaterStore,DryWasteStore,CarriedFoodStore);
...
disp('Simulation Run without ISRU')
