...
PeanutShelf2 = ShelfImpl3(Peanut,72.68/2,Inflatable2,CropWaterStore,CropWaterStore,MainPowerStore,BiomassStore);
SoybeanShelf2 = ShelfImpl3(Soybean,39.7/2,Inflatable2,CropWaterStore,CropWaterStore,MainPowerStore,BiomassStore);
SweetPotatoShelf2 = ShelfImpl3(SweetPotato,9.8/2,Inflatable2,CropWaterStore,CropWaterStore,MainPowerStore,BiomassStore);
WheatShelf2 = ShelfImpl3(Wheat,72.53/2,Inflatable2,CropWaterStore,CropWaterStore,MainPowerStore,BiomassStore);
...
% Inflatable 2
WhitePotatoShelves2 = ShelfStagger(WhitePotatoShelf2,WhitePotatoShelf2.Crop.TimeAtCropMaturity,0);
PeanutShelves2 = ShelfStagger(PeanutShelf2,PeanutShelf2.Crop.TimeAtCropMaturity,0);
SoybeanShelves2 = ShelfStagger(SoybeanShelf2,SoybeanShelf2.Crop.TimeAtCropMaturity,0);
SweetPotatoShelves2 = ShelfStagger(SweetPotatoShelf2,SweetPotatoShelf2.Crop.TimeAtCropMaturity,0);
WheatShelves2 = ShelfStagger(WheatShelf2,WheatShelf2.Crop.TimeAtCropMaturity,0);
...
% Inflatable 1
co2Injector1 = CO2Injector(Inflatable1,CO2Store,targetCO2conc);
% Inflatable 2
